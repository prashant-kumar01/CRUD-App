...
const ContactForm = (props) => {
    ...
    return (
        <form name="myForm" autoComplete="off" onSubmit={handleFormSubmit}>
            <div className="form-group input-group">
                ...
                <input className="form-control" placeholder="Full Name" name="fullName" type="text"
            ...
            <div className="form-row">
                <div className="form-group input-group col-md-6">
                    ...
                    <input className="form-control" placeholder="Mobile" name="mobile" type="number"
                        value={values.mobile}
                        onChange={handleInputChange}
                    />
                </div>
